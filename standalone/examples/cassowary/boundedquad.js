// version of the quadrilateral that is required to stay within a rectangle
// use a strong edit constraint (rather than required) so that when it bumps
// into the rectangle, we just move as close as possible to the mouse
...
contentLoaded(window, function() {
    ...
    // make everything stay within the window frame
